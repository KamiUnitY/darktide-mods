return {
	...
	camera_follow_limit = { en = "Camera sway" },
	camera_follow_limit_description = {
		en = "Limits how far the delayed HUD can move from its original position, measured against the shorter screen dimension.",
	},
}
